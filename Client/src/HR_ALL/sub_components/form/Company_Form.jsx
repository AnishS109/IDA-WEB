...
const Company_Form = () => {
  ...
  const [companyTechData, setCompanyTechData] = useState({
    companyName: '',
    companyLocation: '',
    companyType: "",
    contactDetails: '',
  ...
  const handleChange = (e) => {
    ...
    setCompanyTechData({ ...companyTechData, [name]: value });
  };
  ...
  const handleSubmit = async(e) => {
    ...
    if (!/^\d{10}$/.test(companyTechData.contactDetails)) {
      setLoad(false)
    ...
    try {
      const response = await axios.post(`${backendUrl}/HR/Company-Details`, companyTechData)
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <FormControl fullWidth sx={{ marginBottom: 2 }}>
            ...
            <Select
              value={companyTechData.companyType}
              name="companyType"
              onChange={(e) => setCompanyTechData({ ...companyTechData, companyType: e.target.value })}
              required
            >
          ...
          <TextField
            ...
            name="companyName"
            fullWidth
            value={companyTechData.companyName}
          ...
          <TextField
            ...
            fullWidth
            value={companyTechData.companyLocation}
            onChange={handleChange}
            sx={{ marginBottom: 2 }}
          />
          ...
          <TextField
            ...
            name="contactDetails"
            fullWidth
            value={companyTechData.contactDetails}
            onChange={handleChange}
            sx={{ marginBottom: 2 }}
          />
          ...
          <TextField
            ...
            value={companyTechData.dealWith}
            onChange={handleChange}
            sx={{ marginBottom: 3 }}
          />
